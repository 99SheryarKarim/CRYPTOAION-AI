...
import { Register, Login } from "../../RTK/Slices/AuthSlice"
import { useNavigate } from "react-router-dom"

const Signup = () => {
  const dispatch = useDispatch()
  const navigate = useNavigate()
  const { loading, showToast, toastMessage, toastStatus, token } = useSelector((state) => state.Auth)
  ...
  const handleSubmit = (e) => {
    ...
    if (isLogin) {
      ...
      // Handle registration - log the data being sent
    ...
    <div className="auth-container">
      ...
      <div className="auth-card">
        <div className="auth-header">
          ...
          <h1>AION AI</h1>
          <p className="tagline">Yours Intelligent Crypto Assistant</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="auth-form">
          ...
          <button type="submit" className="submit-button" disabled={loading}>
            {loading ? <div className="button-loader"></div> : isLogin ? "Sign In" : "Create Account"}
          </button>
        </form>
